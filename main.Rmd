...
refer to the respective first, second, or third logistic regression model).

```{r}
candidateLRModel <- ifelse(
  which.max(logregResults[2,]) == 1,
  logreg1,
  ifelse( which.max(logregResults[2,]) == 2,
          logreg2, logreg3)
)
```
